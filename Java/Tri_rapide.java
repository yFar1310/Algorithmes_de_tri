    ...
    public static int partition(int T[], int debut, int fin)
{
    ...
    swap(T,indicePivot,debut);//On permute le plus grand element avec le premier element du tableau
    ...
    public static void rapide(int T[], int debut , int fin)
    {
        if(debut >= fin) return ;
    ...
    public static void affiche(int T[],int size)
    {
...
public static void main(String[] args) {
    ...
    //Exemple de tableau de 100 elements non triés
